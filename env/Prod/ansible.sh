...
- hosts: localhost
  ...
  tasks:
    ...
    - name: Installing dependencies with pip (Django and Django Rest)
      pip:
        virtualenv: /home/ubuntu/web/venv
    ...
    #     path: /home/ubuntu/web/setup/settings.py
    #   register: project_exists # registering the result of the stat command, in this case True or False
    # - name: Starting the Project
    #   shell: '. /home/ubuntu/web/venv/bin/activate; django-admin startproject setup /home/ubuntu/web/'
    ...
    - name: Configuring the database # In Django specifically, doesn't return error if we run twice, but it just try to run and finish the execution without errors.
      shell: '. /home/ubuntu/web/venv/bin/activate; python /home/ubuntu/web/manage.py migrate'
    - name: Loading initial data # Provided by the development team
      shell: '. /home/ubuntu/web/venv/bin/activate; python /home/ubuntu/web/manage.py loaddata clientes.json'
    - name: Starting the server
      shell: '. /home/ubuntu/web/venv/bin/activate; nohup python /home/ubuntu/web/manage.py runserver 0.0.0.0:8000 &'
EOT
